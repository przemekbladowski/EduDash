...
export function TeacherDashboard() {
  ...
  return (
    <>
      <SeoHead title="Dashboard Nauczyciela" description="Panel nauczyciela EduDash — podgląd lekcji, potwierdzanie realizacji, zgłaszanie awarii i szybki dostęp do grafiku." />
