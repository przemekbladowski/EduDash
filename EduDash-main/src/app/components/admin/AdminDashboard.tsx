...
export function AdminDashboard() {
  ...
  return (
    <>
      <SeoHead title="Panel Administratora" description="Panel administracyjny EduDash — przegląd grafiku, konflikty sal, statystyki i zarządzanie placówką edukacyjną." />
